...
unsigned long long int solve_heuristic(const State &state, int ore_robot_ore_cost, int clay_robot_ore_cost, int obsidian_robot_ore_cost, int obsidian_robot_clay_cost, int geode_robot_ore_cost, int geode_robot_obsidian_cost, int total_minutes=24, int threshold1=3, int threshold2=10, int threshold3=17) {
...
unsigned long long int solve_heuristic_multiple(const State &state, int ore_robot_ore_cost, int clay_robot_ore_cost, int obsidian_robot_ore_cost, int obsidian_robot_clay_cost, int geode_robot_ore_cost, int geode_robot_obsidian_cost, int total_minutes=24) {
    int num_tries = 1000;
    ...
    for (int i = 0; i < num_tries; i++) {
        ...
        curr_solution = solve_heuristic(state, ore_robot_ore_cost, clay_robot_ore_cost, obsidian_robot_ore_cost, obsidian_robot_clay_cost, geode_robot_ore_cost, geode_robot_obsidian_cost, total_minutes, threshold1, threshold2, threshold3);
...
// Is this too strict?
unsigned long long int upper_bound(const State &state, int ore_robot_ore_cost, int clay_robot_ore_cost, int obsidian_robot_ore_cost, int obsidian_robot_clay_cost, int geode_robot_ore_cost, int geode_robot_obsidian_cost, int curr_minute, int total_minutes) {
    ...
    // Upper bound ore
    for (int min = curr_minute + 1; min <= total_minutes+1; min++) {
    ...
    for (int min = curr_minute; min <= total_minutes; min++) {
    ...
    return max_geodes[total_minutes+1];
}


unsigned long long int LOWER_BOUND;

unsigned long long int solve_branch_and_bound(const State &state, int ore_robot_ore_cost, int clay_robot_ore_cost, int obsidian_robot_ore_cost, int obsidian_robot_clay_cost, int geode_robot_ore_cost, int geode_robot_obsidian_cost, int minute, int curr_score, int total_minutes) {
    ...
    if (minute >= 10) {
        auto upper_limit = upper_bound(state, ore_robot_ore_cost, clay_robot_ore_cost, obsidian_robot_ore_cost, obsidian_robot_clay_cost, geode_robot_ore_cost, geode_robot_obsidian_cost, minute, total_minutes);
    ...
    best_val = solve_branch_and_bound(tmp_state.obtain_ore(), ore_robot_ore_cost, clay_robot_ore_cost, obsidian_robot_ore_cost, obsidian_robot_clay_cost, geode_robot_ore_cost, geode_robot_obsidian_cost, minute+1, curr_score + state.geode_robots, total_minutes);
    ...
    if (state.ore >= ore_robot_ore_cost) {
        ...
        curr_val = solve_branch_and_bound(tmp_state, ore_robot_ore_cost, clay_robot_ore_cost, obsidian_robot_ore_cost, obsidian_robot_clay_cost, geode_robot_ore_cost, geode_robot_obsidian_cost, minute+1, curr_score + state.geode_robots, total_minutes);
...
int main() {
    ...
    for (std::string line : lines) {
        ...
        LOWER_BOUND = solve_heuristic_multiple(initial_state, ore_robot_ore_cost, clay_robot_ore_cost, obsidian_robot_ore_cost, obsidian_robot_clay_cost, geode_robot_ore_cost, geode_robot_obsidian_cost, total_num_minutes);
        unsigned long long int max_geodes = solve_branch_and_bound(initial_state, ore_robot_ore_cost, clay_robot_ore_cost, obsidian_robot_ore_cost, obsidian_robot_clay_cost, geode_robot_ore_cost, geode_robot_obsidian_cost, 1, 0, total_num_minutes);
        std::cout << "ID " << ID << ": " <<  max_geodes << "\n";
